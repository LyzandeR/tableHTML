...
```{r example_1}
#library(tableHTML)
devtools::load_all('/home/clemens/tableHTML/')
tableHTML(mtcars,
          widths = rep(100, 12)) %>%
...
tableHTML(mtcars, 
  ...
  add_css_header(css = list(c('transform', 'height'),
                            c('rotate(-45deg)', '50px')),
                 headers = 3:13) %>%
 add_css_row(css = list('background-color', '#f2f2f2'), rows = even(3:34)) %>%
  add_css_conditional_column(colour_rank_css = make_css_colour_rank_theme(list(row_groups = 1:3),
                                                                          colors = c('#00b200',
                                                                                     '#007f00',
                                                                                     '#004c00'),
                                                                          css_property = 'color'),
 ...
 add_css_conditional_column(conditional = "contains",
                            ...
                            columns = "row_groups") %>%
  add_css_conditional_column(colour_rank_theme = 'RAG', columns = 4)
```
