...
they are part of the text of the data.frame, which results into missing text. For example if we
do not escape the below data.frame:

```{r escaping} 
df <- data.frame(a = c('ldsfkj<hfdasdf'))
tableHTML(df, escape = FALSE)
```
