...
with any application that accepts HTML (e.g. shiny, rmarkdown, Outlook, PowerPoint). 
...
You can also check the [make_css](https://cran.r-project.org/web/packages/tableHTML/vignettes/make_css.html) 
